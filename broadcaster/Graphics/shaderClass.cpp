...
void Graphics::Shader::setVec3(const std::string& name, glm::vec3 vector) const
{
	glUniform3fv(glGetUniformLocation(ID, name.c_str()), 1, &vector[0]);
}


void Graphics::Shader::setMat4(const std::string& name, glm::mat4 matrix) const
{
...
void Graphics::Shader::compileErrors(unsigned int shader, const char* type)
{
